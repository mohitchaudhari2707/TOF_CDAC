            ...
            {window.localStorage.getItem("user_role") !== 'DELIVERY_BOY' &&
              ...
              <a href="/home">
                <a className="navbar-brand">
                  <img src={logo} class="img-fluid" alt="The Organic farm" width="40px" height="40px" className='logo_' />
                  <lable className="logo_name">THE ORGANIC FARM</lable>
                </a>
              </a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                {window.localStorage.getItem("user_role") !== 'DELIVERY_BOY' &&
                  window.localStorage.getItem("user_role") !== 'ADMIN' &&
                  window.localStorage.getItem("user_role") !== 'SUPPLIER' &&
                  <li className="nav-item navbar-nav navitems">
                    <Link to="/home">
                      <a className="nav-link nameColor2  ms-auto"><h5>Home</h5></a>
                    </Link>
                  </li>
                }
                {window.localStorage.getItem("user_role") == 'DELIVERY_BOY' &&
                  <li className="nav-item">
                    <Link to="/deliveryboyhome">
                      <a className="nav-link  navitems"><h5>Home</h5></a>
                    </Link>
                  </li>
                }
                {window.localStorage.getItem("user_role") == 'ADMIN' &&
                ...
                {this.state.st && window.localStorage.getItem("user_role") == 'CUSTOMER' &&
                  <li class="nav-item dropdown" id='dropdown'>
                    <h5>
                      <a class="nav-link dropdown-toggle  ms-auto " href="myaccount" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        My Account
                      </a>
                      <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id='dropdowncontent' >
                ...
                {window.localStorage.getItem("user_role") !== 'DELIVERY_BOY' &&
                  window.localStorage.getItem("user_role") !== 'SUPPLIER' &&
                  window.localStorage.getItem("user_role") !== 'ADMIN' &&
                  <li class="nav-item dropdown" className='navitems' id='dropdown'>
                    <h5>
                      <a class="nav-link dropdown-toggle  ms-auto" href="myaccount" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Category
                      </a>
                ...
                <ul className="nav justify-content">
                  <form className="form-inline">
                    <div class="input-group search-box">
                      <input className="form-inline me-2" size="50" type="text" placeholder="   What are you looking for?" aria-label="Search" name="searchProduct" value={this.state.searchProduct} onChange={this.onChange} />
                      <span class="input-group-btn">
                        <button className="btn " type="submit" onClick={this.searchProductByName}><i class="fa fa-search"></i></button>
                      </span>
                    </div>
                  </form>
                </ul>
                ...
                {!this.state.st &&
                  <li className="nav-item">
                    <Link to="/create-account">
                      <a className="nav-link "><h5 className="nameColor1">Sign Up</h5></a>
                    </Link>
                  </li>
                }
                {!this.state.st &&
                  <li className="nav-item " >
                    <Link to="/login">
                      <a className="nav-link "><h5 className="nameColor1">Log-In</h5></a>
                    </Link>
                  </li>
                }
                {this.state.st &&
                  <li className="nav-item" >
                      ...
                      <a className="nav-link"><h5 className="nameColor1">Hello, {window.localStorage.getItem("user_fname")}</h5></a>
